    ...
    <div>
      ...
      <section className="mt-6 rounded-2xl border border-border bg-surface/50 p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="font-semibold text-fg">Torres y edificios</h2>
            <p className="mt-1 text-sm text-fg-muted">Agrupá unidades y plantas por torre.</p>
          </div>
          <ButtonLink href={`/dashboard/projects/${project.id}/torres`} size="sm" variant="outline">
            Gestionar torres
          </ButtonLink>
        </div>
      </section>
